...
<Step title="Prepare your dataset">
  Process data into conversation or preference format using the [dataset preprocessing guide](/dataset/introduction.mdx).
  <Check>
...
<Step title="Enable PEFT and quantization if needed">
