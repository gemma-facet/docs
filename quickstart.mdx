...
<Note>
**Prerequisites:** You'll need a Facet AI account. If you don't have one, [sign up here](https://gemma-facet.vercel.app) first.
</Note>
...
<Step title="Configure Dataset Processing">
  1. After upload, configure your dataset:
     ...
     - **Format**: Select the appropriate format for your data
     - **Augmentation**: Enable data augmentation if desired
...
<Step title="Create Training Configuration">
  ...
  <Info>
  For your first model, we recommend starting with Gemma 3 1B for a good balance of speed and quality.
  </Info>
</Step>
...
<Step title="Configure Training Parameters">
  ...
  - **Training Steps**: Default (1000) is good for quick testing
  - **Training Method**: Choose SFT (Supervised Fine-Tuning) for most tasks
...
<Card title="Evaluation Techniques" icon="chart-line" href="/evaluation/inference_export">
...
<Accordion title="Poor model performance">
  - Try a larger model size (1B → 4B → 12B)
  - Increase training steps
  - Check your dataset quality and size
...
<Note>
**Need more help?** Check out our [comprehensive tutorials](/tutorials) or contact support at facet.gemma@gmail.com.
</Note>
